...
RCPP_MODULE(Tgarch){  
  ...
  ;
   ...
   // Tgarch-normal-skew
  class_<Tgarch_normal_skew>("Tgarch_normal_skew")  
	.constructor()
	.field( "name",        &Tgarch_normal_skew ::name )
	.field( "theta0",      &Tgarch_normal_skew ::theta0 )
	.field( "Sigma0",      &Tgarch_normal_skew ::Sigma0 )
	.field( "label",       &Tgarch_normal_skew ::label )
	.field( "lower",       &Tgarch_normal_skew ::lower )
	.field( "upper",       &Tgarch_normal_skew ::upper )
	.field( "ineq_lb",     &Tgarch_normal_skew ::ineq_lb )
	.field( "ineq_ub",     &Tgarch_normal_skew ::ineq_ub )
	.field( "NbParams",    &Tgarch_normal_skew ::NbParams )
	.field( "NbParamsModel",&Tgarch_normal_skew ::NbParamsModel)
	.method( "f_sim",      &Tgarch_normal_skew ::f_sim )
	.method( "f_pdf",      &Tgarch_normal_skew ::f_pdf )
	.method( "f_cdf",      &Tgarch_normal_skew ::f_cdf )
	.method( "f_rnd",      &Tgarch_normal_skew ::f_rnd )
	.method( "calc_ht",    &Tgarch_normal_skew ::calc_ht )
	.method( "eval_model", &Tgarch_normal_skew ::eval_model )
	.method( "ineq_func",  &Tgarch_normal_skew ::ineq_func )
	.method( "f_unc_vol",  &Tgarch_normal_skew ::f_unc_vol)
  ;
   // Tgarch-student-skew
  class_<Tgarch_student_skew>("Tgarch_student_skew")  
    .constructor()
    .field( "name",        &Tgarch_student_skew ::name )
    .field( "theta0",      &Tgarch_student_skew ::theta0 )
    .field( "Sigma0",      &Tgarch_student_skew ::Sigma0 )
    .field( "label",       &Tgarch_student_skew ::label )
    .field( "lower",       &Tgarch_student_skew ::lower )
    .field( "upper",       &Tgarch_student_skew ::upper )
    .field( "ineq_lb",     &Tgarch_student_skew ::ineq_lb )
    .field( "ineq_ub",     &Tgarch_student_skew ::ineq_ub )
    .field( "NbParams",    &Tgarch_student_skew ::NbParams )
	.field( "NbParamsModel",&Tgarch_student_skew ::NbParamsModel)
    .method( "f_sim",      &Tgarch_student_skew ::f_sim )
    .method( "f_pdf",      &Tgarch_student_skew ::f_pdf )
    .method( "f_cdf",      &Tgarch_student_skew ::f_cdf )
    .method( "f_rnd",      &Tgarch_student_skew ::f_rnd )
    .method( "calc_ht",    &Tgarch_student_skew ::calc_ht )
    .method( "eval_model", &Tgarch_student_skew ::eval_model )
    .method( "ineq_func",  &Tgarch_student_skew ::ineq_func )
    .method( "f_unc_vol",  &Tgarch_student_skew ::f_unc_vol)
  ;
  // Tgarch-ged-skew

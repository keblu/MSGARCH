...
RCPP_MODULE(GAS){ 
  ...
  class_<GAS_norm_sym>("GAS_norm_sym")  
    ...
    .method( "f_simAhead",  &GAS_norm_sym ::f_simAhead )
  ...
  class_<GAS_std_sym>("GAS_std_sym")  
    ...
    .method( "f_simAhead",  &GAS_std_sym ::f_simAhead )
  ...
  class_<GAS_ged_sym>("GAS_ged_sym")  
    ...
    .method( "f_simAhead",  &GAS_ged_sym ::f_simAhead )
  ...
  class_<GAS_norm_skew>("GAS_norm_skew")  
    ...
    .method( "f_simAhead",  &GAS_norm_skew ::f_simAhead )
  ...
  class_<GAS_std_skew>("GAS_std_skew")  
    ...
    .method( "f_simAhead",  &GAS_std_skew ::f_simAhead )
  ...
  class_<GAS_ged_skew>("GAS_ged_skew")  
    ...
    .method( "f_simAhead",  &GAS_ged_skew ::f_simAhead )

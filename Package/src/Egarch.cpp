...
RCPP_MODULE(eGARCH){  
  ...
  .method( "f_pdf_its",  &eGARCH_norm_sym ::f_pdf_its )
	.method( "f_cdf",      &eGARCH_norm_sym ::f_cdf )
 .method( "f_cdf_its",  &eGARCH_norm_sym ::f_cdf_its )
 .method( "f_simAhead",  &eGARCH_norm_sym ::f_simAhead )
  ...
  class_<eGARCH_std_sym>("eGARCH_std_sym")  
    ...
    .method( "f_pdf_its",  &eGARCH_std_sym ::f_pdf_its )
    .method( "f_cdf",      &eGARCH_std_sym ::f_cdf )
    .method( "f_cdf_its",  &eGARCH_std_sym ::f_cdf_its )
    .method( "f_simAhead",  &eGARCH_std_sym ::f_simAhead )
  ...
  class_<eGARCH_ged_sym>("eGARCH_ged_sym")  
    ...
    .method( "f_pdf_its",  &eGARCH_ged_sym ::f_pdf_its )
    .method( "f_cdf",      &eGARCH_ged_sym ::f_cdf )
    .method( "f_cdf_its",  &eGARCH_ged_sym ::f_cdf_its )
    .method( "f_simAhead",  &eGARCH_ged_sym ::f_simAhead )
  ...
  .method( "f_pdf_its",  &eGARCH_norm_skew ::f_pdf_its )
	.method( "f_cdf",      &eGARCH_norm_skew ::f_cdf )
 .method( "f_cdf_its",  &eGARCH_norm_skew ::f_cdf_its )
 .method( "f_simAhead",  &eGARCH_norm_skew ::f_simAhead )
  ...
  class_<eGARCH_std_skew>("eGARCH_std_skew")  
    ...
    .method( "f_pdf_its",  &eGARCH_std_skew ::f_pdf_its )
    .method( "f_cdf",      &eGARCH_std_skew ::f_cdf )
    .method( "f_cdf_its",  &eGARCH_std_skew ::f_cdf_its )
    .method( "f_simAhead",  &eGARCH_std_skew ::f_simAhead )
  ...
  class_<eGARCH_ged_skew>("eGARCH_ged_skew")  
    ...
    .method( "f_pdf_its",  &eGARCH_ged_skew ::f_pdf_its )
    .method( "f_cdf",      &eGARCH_ged_skew ::f_cdf )
    .method( "f_cdf_its",  &eGARCH_ged_skew ::f_cdf_its )
    .method( "f_simAhead",  &eGARCH_ged_skew ::f_simAhead )

#' Predictive density function at T + 1.
#' @description Method returning the predictive probability density at T + 1 of a vector of points.
...
#'x = rnorm(100)
#'
#'# run pred method on random draws
#'pred = MSGARCH::pred(spec = spec, x = x, theta = spec$theta0, y = sp500ret, log = TRUE)
#' @return (Log-)Predictive density at T + 1 of \code{x} (vector of size N).
#' @export

...
#'        \item \code{theta0} : Starting value for the chain (if empty the specification default values are used).
#'        \item \code{do.enhance.theta0} : Boolean indicating if the default parameters values are enhanced using \code{y} variance. (Default: \code{do.enhance.theta0 = FALSE})
#'        }
...
#'  uses the volatilities of rolling windows of \code{y} and adjusts the default parameter of
